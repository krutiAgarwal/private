...
public class NGITReporter implements IReporter{
	
	
	private static final String emailableReportTemplateFile = "/Users/nitinagarwal/git/Cucumber-TestNG/src/main/java/MyRunner/customize-emailable-report-template.html";
